...
import static com.mrhabibi.persistentdialog.DialogActivity.CANCELABLE_LABEL;
import static com.mrhabibi.persistentdialog.DialogActivity.FRAGMENT_GETTER_ID_LABEL;
import static com.mrhabibi.persistentdialog.DialogActivity.IDENTIFIER_LABEL;
import static com.mrhabibi.persistentdialog.DialogActivity.PARAMS_LABEL;
import static com.mrhabibi.persistentdialog.DialogActivity.THEME_RES_LABEL;
import static com.mrhabibi.persistentdialog.DialogResult.REQUEST_PERSISTENT_DIALOG;

/**
 * Created by mrhabibi on 12/2/16.
 * This is the official PersistentDialog builder class, experimental stuff because
...
public class PersistentDialog {
    ...
    public final static String TAG = "PersistentDialog";
        ...
        public Builder setContent(@NonNull Intent intent, @Nullable Fragment fragment) {
            try {
                if (!(DialogActivity.class.isAssignableFrom(Class.forName(intent.getComponent().getClassName())))) {
                    throw new IllegalStateException("Intent class for PersistentDialog must inherit DialogActivity class!");
                }
